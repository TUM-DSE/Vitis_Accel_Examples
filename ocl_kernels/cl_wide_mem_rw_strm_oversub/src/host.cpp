...
// Artificial limit for available FPGA memory to simulate memory over-subscription
#define MEM_LIMIT (1 * 1024 * 1024)
...
#define DATA_SIZE (128 * 1024 * 1024) // 3 buffers (2 input, 1 output) of this size
