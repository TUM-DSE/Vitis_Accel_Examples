...
LINK_OUTPUT := $(BUILD_DIR)/transformer.link.xclbin
PACKAGE_OUT = ./package.$(TARGET)

VPP_PFLAGS :=
CMD_ARGS = $(BUILD_DIR)/transformer.xclbin
...
all: check-platform check-device check-vitis $(EXECUTABLE) $(BUILD_DIR)/transformer.xclbin emconfig

.PHONY: host
host: $(EXECUTABLE)

.PHONY: build
build: check-vitis check-device $(BUILD_DIR)/transformer.xclbin
...
$(BUILD_DIR)/transformer.xclbin: $(TEMP_DIR)/transformer.xo
	...
	v++ -p $(LINK_OUTPUT) $(VPP_FLAGS) -t $(TARGET) --platform $(PLATFORM) --package.out_dir $(PACKAGE_OUT) -o $(BUILD_DIR)/transformer.xclbin
